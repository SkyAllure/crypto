...
//  crypto
//
//  Created by Swan Garcia
//  Copyright © 2020 Swan Garcia. All rights reserved.
//
//
/*  I DID NOT CREATE THIS CODE I WENT THROGH A TUTORIAL ON YOUTUBE: https://www.youtube.com/watch?v=dRYHSf5A4lw&list=PLKK11LigqitiRH57AbtyJyzsfbNfA8nb-
    THE CREDIT BELONGS TO A USER THAT GOES BY THE NAME "What's a Creel?"
 */


#include <iostream>
#include <ncurses.h> // conio

using namespace std;

// Got this from https://cryptography.fandom.com/wiki/Rijndael_S-box
int s[256] =
...
void KeyExpansionCore(unsigned char* in, unsigned char i){
    ...
    *q = (*q >> 8) | ((*q & 0xff) << 24);
    ...
    //s-box
    in[0] = s[in[0]]; in[1] = s[in[1]];
    in[2] = s[in[2]]; in[3] = s[in[3]];
